...
### Guia do artigo:
- [O que é o Maven?](##O que é o Maven?)
- [Instalando o Maven](## Instalando o Maven)
- [Criando um projeto simples](## Criando um projeto simples)
- [Gerenciamento de Dependências](## Gerenciamento de Dependências)
- [O arquivo pom.xml]()
- [Expandindo nosso exemplo](## Expandindo nosso exemplo)
- [Ciclo de Vida de Construção](## Ciclo de Vida de Construção)
- [Plugins](## Plugins)
- [Criando um projeto web](## Criando um projeto web)
- [Dicas](## Dicas)
...
- [Aplicativos híbridos com Ionic:](https://www.devmedia.com.br/aplicativos-hibridos-com-ionic/39149)
	Veja como criar aplicativos de forma rápida, flexível e produtiva para a plataforma do Ionic.
- [Transformando layouts em código:](https://www.devmedia.com.br/transformando-layouts-em-codigo/39148)
...
[Site oficial do Maven.](https://www.devmedia.com.br/introducao-ao-maven/25128)
[Site oficial do Java.](https://www.oracle.com/java/)
[Site com plugin do Maven para o Eclipse.](https://maven.apache.org/plugins/maven-eclipse-plugin/usage.html)
[Site com plugin do Maven para o NetBeans.](http://wiki.netbeans.org/Maven)
[Site com plugin do Maven para o IntelliJ IDEA.](https://www.jetbrains.com/idea/features/ant_maven.htm)

[Artigo original](https://www.devmedia.com.br/introducao-ao-maven/25128)

[Curso de Maven na DevMedia](https://www.devmedia.com.br/curso/curso-de-maven-framework/419)